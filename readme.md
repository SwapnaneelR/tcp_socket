...
## Demonstration
> Watch this YouTube video that demonstrates all the major features: [Watch on YouTube](https://youtu.be/yeS1U2xY6kY?si=_Vcqccc7LZxDLkdm)

## How to use it?
``git clone https://github.com/SwapnaneelR/tcp_socket``

Navigate to both the directories :
...
- Simple login system (``LOGIN <username>``)

- Broadcast messaging (``MSG <text>``)
